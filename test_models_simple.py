#!/usr/bin/env python3
"""
Simplified test script for Mount Rainier weather models
Uses only core features to avoid feature mismatch issues
...
def create_simple_features(df):
    """
    Create simple, core features that match what the models expect
...
def save_results(results, year):
    ...
    # Save to CSV
    results_file = PROCESSED_DATA_DIR / f"model_evaluation_{year}_simple.csv"
...
def main():
    ...
    print("🧪 Mount Rainier Model Testing - Simplified")
    print("=" * 60)
