#!/usr/bin/env python3
"""
Basic test script for Mount Rainier weather models
Uses only the core weather variables to test model performance
...
def create_basic_features(df):
    """
    Create only the most basic features that the models expect
    ...
    # Create only the most essential features that the models expect
    ...
    # Create is_daylight feature (models expect this)
    ...
    # Create lag features (1, 2, 3 hours) - these are crucial
    ...
    # Create rolling averages (3, 6, 12 hours) - these are also important
    for var in ['temperature_F', 'wind_speed_mph', 'air_pressure_hPa', 'precip_hourly']:
...
def main():
    ...
    for year in ['2015', '2016']:
        ...
        df_features = create_basic_features(test_data)
