#!/usr/bin/env python3
"""
Test trained models on 2015 Mount Rainier weather data

This script loads the trained models and tests them on the 2015 test data
...
def load_2015_test_data():
    """
    Load the 2015 test data
    
    Returns:
        DataFrame with 2015 test data
    """
    print("📊 Loading 2015 test data...")
    
    test_file = PROCESSED_DATA_DIR / "TEST_ERA5_2015.csv"
    ...
    try:
        ...
        print(f"   ✅ Loaded 2015 test data: {df.shape}")
...
def prepare_features(df):
    ...
    """
    print("🔧 Creating features for 2015 test data...")
...
def evaluate_model_performance(models, df_features):
    """
    Evaluate model performance on 2015 test data
    ...
    """
    print("📈 Evaluating model performance on 2015 data...")
...
def save_results(results):
    ...
    # Save to CSV
    results_file = PROCESSED_DATA_DIR / "model_evaluation_2015.csv"
    results_df.to_csv(results_file)
    print(f"   ✅ Results saved to {results_file}")
    
    # Print summary
    print(f"\n📋 2015 Evaluation Summary:")
    print(results_df.round(3))

def main():
    """Main function to test models on 2015 data"""
    print("🧪 Mount Rainier Model Testing - 2015 Data")
    print("=" * 60)
    ...
    print(f"\n🎉 2015 model testing completed!")
    print(f"📊 Tested on {len(test_data)} records from 2015")
